...
import static net.infinityrooms.EndlessTrapdoor.*;
...
public class PressurePlateModel extends BlockModel {
    ...
    public void emitBlockQuads(BlockRenderView blockRenderView, BlockState blockState, BlockPos blockPos, Supplier<Random> supplier, RenderContext renderContext) {
        ...
        for(Direction direction : Direction.values()) {
            ...
            if (direction == Direction.UP && blockState.get(POWERED)) {
            ...
            } else if ((direction == Direction.NORTH && blockState.get(POWERED)) || ((direction == Direction.SOUTH && blockState.get(POWERED)))
                    || (direction == Direction.WEST && blockState.get(POWERED)) || (direction == Direction.EAST && blockState.get(POWERED))) {
