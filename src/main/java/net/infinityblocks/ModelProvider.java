...
import net.infinityblocks.blocks.models.*;
...
public class ModelProvider implements ModelResourceProvider {
    ...
    public UnbakedModel loadModelResource(Identifier identifier, ModelProviderContext modelProviderContext) {
        ...
        for (int i = 0; i < 16; i++) {
            if (identifier.equals(new Identifier("infinityblocks:block/endless_" + colors.get(i) + "_model")) ||
            identifier.equals(new Identifier("infinityblocks:item/endless_" + colors.get(i)))) {
                return new BlockModel(colors.get(i));
            } else if (identifier.equals(new Identifier("infinityblocks:block/endless_" + colors.get(i) + "_door_model"))) {
                return new DoorModel(colors.get(i));
            } else if (identifier.equals(new Identifier("infinityblocks:block/endless_" + colors.get(i) + "_trapdoor_model"))) {
                return new TrapdoorModel(colors.get(i));
            } else if (identifier.equals(new Identifier("infinityblocks:block/endless_" + colors.get(i) + "_button_model"))) {
                return new ButtonModel(colors.get(i));
            } else if (identifier.equals(new Identifier("infinityblocks:block/endless_" + colors.get(i) + "_pressure_plate_model"))) {
